...
if __name__ == "__main__":
    ...
    africa_targets = "@SafaricomPLC OR @MTNGroup OR @DangoteGroup OR @KCB OR @Equity OR @ABSA OR @SFA OR @Netflix OR @NCBA OR @MOH OR @AWF OR @BIDCO OR @East African Breweries Limited OR @MasterCard OR @MasterCard Foundation OR #AFCON OR #WorldCup OR #TechInAfrica #AI OR #AMR"            
